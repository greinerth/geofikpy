...
pybind11::object _franka_J_ik_q4(
  ...
  std::array<std::array<double, 7>, 8> qsols{};
  unsigned int sol =  franka_J_ik_q4(r, ROE, q4, Jsols, qsols, joint_angles, Jacobian_ee, q1_sing);
...
pybind11::object _franka_J_ik_q6(
                            const std::array<double, 3>& r,
                            const std::array<double, 9>& ROE,
                            const double q6,
                            const bool joint_angles = false,
  ...
  std::array<std::array<std::array<double, 6>, 7>, 8> Jsols{};
  std::array<std::array<double, 7>, 8> qsols{};
  unsigned int sol =  franka_J_ik_q6(r, ROE, q6, Jsols, qsols, joint_angles, Jacobian_ee, q1_sing);
...
py::object _franka_J_ik_q7(
  ...
  std::array<std::array<std::array<double, 6>, 7>, 8> Jsols{};
  std::array<std::array<double, 7>, 8> qsols{};
  unsigned int sol =  franka_J_ik_q7(r, ROE, q7, Jsols, qsols, joint_angles, Jacobian_ee, q1_sing);
...
py::object _franka_J_ik_swivel(const std::array<double, 3>& r,
                               const std::array<double, 9>& ROE,
                               const double theta,
                               const bool joint_angles = false,
                               const char Jacobian_ee = 'E',
 ...
 std::array<std::array<std::array<double, 6>, 7>, 8> Jsols{};
  std::array<std::array<double, 7>, 8> qsols{};
  unsigned int sol =  franka_J_ik_swivel(r,
                                         ROE,
                                         theta,
                                         Jsols,
                                         qsols,
...
PYBIND11_MODULE(geofik, m) {
  ...
  m.def("franka_J_ik_q7", &_franka_J_ik_q7, py::arg("r"), py::arg("ROE"), py::arg("q7"), py::arg("joint_angles") = false, py::arg("Jacobian_ee") = 'E', py::arg("q1_sing") = PI/2,
        R"delim(
  ...
  m.def("franka_J_ik_q4", &_franka_J_ik_q4, py::arg("r"), py::arg("ROE"), py::arg("q4"), py::arg("joint_angles") = false, py::arg("Jacobian_ee") = 'E', py::arg("q1_sing") = PI/2,
        R"delim(
  ...
  m.def("franka_J_ik_q6", &_franka_J_ik_q6, py::arg("r"), py::arg("ROE"), py::arg("q6"), py::arg("joint_angles") = false, py::arg("Jacobian_ee") = 'E', py::arg("q1_sing") = PI/2,
        R"delim(
        Compute IK with q4 locked and compute Jacobian
  ...
  m.def("franka_J_ik_swivel", &_franka_J_ik_swivel, py::arg("r"), py::arg("ROE"), py::arg("theta"), py::arg("joint_angles") = false, py::arg("Jacobian_ee") = 'E', py::arg("q1_sing") = PI/2, py::arg("n_points") = 600, py::arg("n_fine_search") = 3,
        R"delim(
        Compute IK with q4 locked and compute Jacobian
