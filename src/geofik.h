 ...
 * @param q1_sing   [optional] emergency value of q1 in case of singularity at
 * shoulder joints (type-1 singularity).
 ...
 * @param q1_sing   [optional] emergency value of q1 in case of singularity at
 * shoulder joints (type-1 singularity).
 * @param q7_sing   [optional] emergency value of q7 in case of singularity of
 * S7 intersecting S (type-2 singularity).
 * @return          number of solutions found.
 */
 ...
 * @param ROE       rotation matrix of frame E with respect to frame O
 * (row-first format).
 * @param theta     swivel angle in radians (see paper for geometric definition)
 * @param qsols     array to store 8 solutions
 * @param q1_sing   [optional] emergency value of q1 in case of singularity at
 * shoulder joints (type-1 singularity).
 ...
 * @param q         joint angles.
 * @return          swivel angle theta (see paper for geometric definition).
 */
 ...
 * @param Jacobian_ee   [optional] ee frame of the Jacobian, not the IK ('E',
 * 'F', '8' or '6').
 * @param q1_sing       [optional] emergency value of q1 in case of singularity
 * at shoulder joints (type-1 singularity).
 * @return              number of solutions found.
 */
 ...
 * @param q1_sing       [optional] emergency value of q1 in case of singularity
 * at shoulder joints (type-1 singularity).
 * @param q7_sing       [optional] emergency value of q7 in case of singularity
 * of S7 intersecting S (type-2 singularity).
 * @return              number of solutions found.
 */
unsigned int
franka_J_ik_q4(const array<double, 3> &r, const array<double, 9> &ROE,
               const double q4, array<array<array<double, 6>, 7>, 8> &Jsols,
               array<array<double, 7>, 8> &qsols,
               const bool joint_angles = false, const char Jacobian_ee = 'E',
               const double q1_sing = PI / 2, const double q7_sing = 0);
 ...
 */
unsigned int
franka_J_ik_q6(const array<double, 3> &r, const array<double, 9> &ROE,
               const double q6, array<array<array<double, 6>, 7>, 8> &Jsols,
               array<array<double, 7>, 8> &qsols,
               const bool joint_angles = false, const char Jacobian_ee = 'E',
               const double q1_sing = PI / 2, const double q7_sing = 0);

/**
 * @brief IK to calculate Jacobian and joint angles with swivel angle as free
 * variable (numerical).
 * @param r             position of frame E with respect to frame O.
 * @param ROE           rotation matrix of frame E with respect to frame O
 * (row-first format).
 * @param theta         swivel angle in radians (see paper for geometric
 * definition).
 * @param Jsols         array to store 8 solutions for the Jacobians.
 * @param qsols         array to store 8 solutions for the joint angles.
 * @param joint_angles  [optional] if false only Jacobians are returned.
 ...
 * @param q1_sing       [optional] emergency value of q1 in case of singularity
 * at shoulder joints (type-1 singularity).
 * @param n_points      [optional] number of points to discretise the range of
 * q7.
 * @return              number of solutions found.
 */
unsigned int franka_J_ik_swivel(
    ...
    array<array<array<double, 6>, 7>, 8> &Jsols,
    array<array<double, 7>, 8> &qsols, const bool joint_angles = false,
