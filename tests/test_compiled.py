...
def test_j_ik(get_q) -> None:
    ...
    q = get_q
    desired = geofik.franka_fk(q)
    _jacs, _configs, idx = geofik.franka_J_ik_q4(
    ...
    _jacs, _configs, idx = geofik.franka_J_ik_q6(
    ...
    _jacs, _configs, idx = geofik.franka_J_ik_swivel(
